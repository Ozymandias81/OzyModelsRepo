...
TITLE LET'S COOK SOME AWESOME MODELS!
...
REM # ================================================================================================
:BufferHeader
ECHO Models Repository Compiler
ECHO =====================
ECHO ---------------------
ECHO =====================
ECHO.&ECHO.&ECHO.
...
IF %featuresGit% NEQ True (
    ...
    IF "%projectName%" NEQ "models_ozy" SET "projectName=models_ozy"
    GOTO :EOF
)
...
REM Avoid redundancy
IF "%projectName%" NEQ "models_ozy-%GitCommitHash%" SET "projectName=models_ozy-%GitCommitHash%"
GOTO :EOF
